...
export const ResumeSettingsSidebar = ({ onClearResume }: ResumeSettingsSidebarProps) => {
  ...
  return (
    <aside
      className={`sticky top-16 self-start h-160 max-h-[calc(100vh-5rem)] shrink-0 bg-white border border-gray-200 rounded-xl shadow-sm transition-all duration-300 print:hidden ${
